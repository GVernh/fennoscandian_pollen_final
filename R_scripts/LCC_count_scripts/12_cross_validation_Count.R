...
Cross_val_df$Lag <- as.integer(Cross_val_df$Lag)
Cross_val_df <- cbind(LCC = rownames(Cross_val_df), Cross_val_df)
write.csv(Cross_val_df, "./Results/Cross_validation/Cross_validation_results_count_before.csv", row.names = F)
...
Cross_val_df$Lag <- as.integer(Cross_val_df$Lag)
Cross_val_df <- cbind(LCC = rownames(Cross_val_df), Cross_val_df)
write.csv(Cross_val_df, "./Results/Cross_validation/Cross_validation_results_count_after.csv", row.names = F)