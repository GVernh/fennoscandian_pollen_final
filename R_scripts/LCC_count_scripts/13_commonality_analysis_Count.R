...
dir.create(file.path("./Results/Commonality_analysis/", "Count_data"), showWarnings = FALSE)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/Com_analysis_NORTH_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/Com_analysis_SOUTHEAST_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/Com_analysis_MIDWEST_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/Com_analysis_MIDMID_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/Com_analysis_SOUTHWEST_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/Com_analysis_SOUTHMID_count.csv", row.names = T)
...
### Granger causality test without significant stars ###
...
coefs[nrow(coefs)+1,] <- NA
rownames(coefs)[rownames(coefs) == nrow(coefs)] <- "Coniferous woodland"
coefs[nrow(coefs),1] <- paste0(round(com$Us*100, 3))
coefs[nrow(coefs),2] <- paste0(round(com$Uc*100, 3))
coefs[nrow(coefs),3] <- paste0(round(com$Csc*100, 3))
...
coefs[1,4] <- paste0(round(com$Us*100, 3))
coefs[1,5] <- paste0(round(com$Uc*100, 3))
coefs[1,6] <- paste0(round(com$Csc*100, 3))
...
coefs[2,4] <- paste0(round(com$Us*100, 3))
coefs[2,5] <- paste0(round(com$Uc*100, 3))
coefs[2,6] <- paste0(round(com$Csc*100, 3))
...
coefs[3,4] <- paste0(round(com$Us*100, 3))
coefs[3,5] <- paste0(round(com$Uc*100, 3))
coefs[3,6] <- paste0(round(com$Csc*100, 3))
...
coefs[4,4] <- paste0(round(com$Us*100, 3))
coefs[4,5] <- paste0(round(com$Uc*100, 3))
coefs[4,6] <- paste0(round(com$Csc*100, 3))
...
coefs[5,4] <- paste0(round(com$Us*100, 3))
coefs[5,5] <- paste0(round(com$Uc*100, 3))
coefs[5,6] <- paste0(round(com$Csc*100, 3))
...
coefs[6,4] <- paste0(round(com$Us*100, 3))
coefs[6,5] <- paste0(round(com$Uc*100, 3))
coefs[6,6] <- paste0(round(com$Csc*100, 3))
...
coefs[7,4] <- paste0(round(com$Us*100, 3))
coefs[7,5] <- paste0(round(com$Uc*100, 3))
coefs[7,6] <- paste0(round(com$Csc*100, 3))
...
coefs[1,7] <- paste0(round(com$Us*100, 3))
coefs[1,8] <- paste0(round(com$Uc*100, 3))
coefs[1,9] <- paste0(round(com$Csc*100, 3))
...
coefs[2,7] <- paste0(round(com$Us*100, 3))
coefs[2,8] <- paste0(round(com$Uc*100, 3))
coefs[2,9] <- paste0(round(com$Csc*100, 3))
...
coefs[3,7] <- paste0(round(com$Us*100, 3))
coefs[3,8] <- paste0(round(com$Uc*100, 3))
coefs[3,9] <- paste0(round(com$Csc*100, 3))
...
coefs[4,7] <- paste0(round(com$Us*100, 3))
coefs[4,8] <- paste0(round(com$Uc*100, 3))
coefs[4,9] <- paste0(round(com$Csc*100, 3))
...
coefs[5,7] <- paste0(round(com$Us*100, 3))
coefs[5,8] <- paste0(round(com$Uc*100, 3))
coefs[5,9] <- paste0(round(com$Csc*100, 3))
...
coefs[6,7] <- paste0(round(com$Us*100, 3))
coefs[6,8] <- paste0(round(com$Uc*100, 3))
coefs[6,9] <- paste0(round(com$Csc*100, 3))
...
coefs[7,7] <- paste0(round(com$Us*100, 3))
coefs[7,8] <- paste0(round(com$Uc*100, 3))
coefs[7,9] <- paste0(round(com$Csc*100, 3))

write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/No_sig_stars/Com_analysis_NORTH_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/No_sig_stars/Com_analysis_SOUTHEAST_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/No_sig_stars/Com_analysis_MIDWEST_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/No_sig_stars/Com_analysis_MIDMID_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/No_sig_stars/Com_analysis_SOUTHWEST_count.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/Count_data/No_sig_stars/Com_analysis_SOUTHMID_count.csv", row.names = T)