...
dir.create(file.path("./", "Results"), showWarnings = FALSE)
dir.create(file.path("./Results/", "Commonality_analysis"), showWarnings = FALSE)
dir.create(file.path("./Results/Commonality_analysis/", "No_sig_stars"), showWarnings = FALSE)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/No_sig_stars/Com_analysis_NORTH_abun.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/No_sig_stars/Com_analysis_SOUTHEAST_abun.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/No_sig_stars/Com_analysis_MIDWEST_abun.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/No_sig_stars/Com_analysis_MIDMID_abun.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/No_sig_stars/Com_analysis_SOUTHWEST_abun.csv", row.names = T)
...
write.csv(as.data.frame(t(coefs)), "./Results/Commonality_analysis/No_sig_stars/Com_analysis_SOUTHMID_abun.csv", row.names = T)
